...
export default forwardRef<HTMLButtonElement, ButtonHTMLAttributes<HTMLButtonElement> & { kind?: "scale" | "opacity" }>(
  function EnsureMatchNetworkButton({ children, onClick, kind = "opacity", ...rest }, ref) {
